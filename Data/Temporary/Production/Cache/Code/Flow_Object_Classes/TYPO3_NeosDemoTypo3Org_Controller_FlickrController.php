 ...
 * Controller that displays flickr photo streams
 */
class FlickrController extends FlickrController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if ('TYPO3\NeosDemoTypo3Org\Controller\FlickrController' === get_class($this)) {
	 ...
	 public function tagStreamAction() {
		...
		$result = parent::tagStreamAction();
			...
			try {
					...
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\NeosDemoTypo3Org\Controller\FlickrController', 'tagStreamAction', $methodArguments, $adviceChain);
		...
		$result = parent::userStreamAction($userId);
			...
			try {
				...
				$methodArguments['userId'] = $userId;
					...
					$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\NeosDemoTypo3Org\Controller\FlickrController', 'userStreamAction', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\NeosDemoTypo3Org\Controller\FlickrController');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\NeosDemoTypo3Org\Controller\FlickrController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\NeosDemoTypo3Org\Controller\FlickrController', $propertyName, 'var');
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$this->tagStreamUriPattern = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Configuration\ConfigurationManager')->getConfiguration(\TYPO3\Flow\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'TYPO3.NeosDemoTypo3Org.flickr.tagStreamUriPattern');
		$this->userStreamUriPattern = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Configuration\ConfigurationManager')->getConfiguration(\TYPO3\Flow\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'TYPO3.NeosDemoTypo3Org.flickr.userStreamUriPattern');
...
$this->Flow_Injected_Properties = array (
  0 => 'settings',
  1 => 'tagStreamUriPattern',
  2 => 'userStreamUriPattern',
  3 => 'objectManager',
  4 => 'reflectionService',
