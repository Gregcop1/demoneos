...
class SchemaController extends SchemaController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$schemaBuilder_reference = &$this->schemaBuilder;
		$this->schemaBuilder = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('TYPO3\Neos\Service\NodeTypeSchemaBuilder');
		if ($this->schemaBuilder === NULL) {
			$this->schemaBuilder = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('2c6771efe1ffef78a39f0585404ab874', $schemaBuilder_reference);
			if ($this->schemaBuilder === NULL) {
				$this->schemaBuilder = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('2c6771efe1ffef78a39f0585404ab874',  $schemaBuilder_reference, 'TYPO3\Neos\Service\NodeTypeSchemaBuilder', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Neos\Service\NodeTypeSchemaBuilder'); });
			}
		}
