	 ...
	 public function __clone() {
		...
		$result = NULL;
			...
			try {
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Model\Workspace', '__clone', $joinPoint->getMethodArguments(), NULL, $result);
		...
		$result = parent::emitBeforeNodePublishing($node, $targetWorkspace);
			...
			try {
				...
				$methodArguments['targetWorkspace'] = $targetWorkspace;
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Model\Workspace', 'emitBeforeNodePublishing', $joinPoint->getMethodArguments(), NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
		...
		$result = parent::emitAfterNodePublishing($node, $targetWorkspace);
			...
			try {
				...
				$methodArguments['targetWorkspace'] = $targetWorkspace;
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Model\Workspace', 'emitAfterNodePublishing', $joinPoint->getMethodArguments(), NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
