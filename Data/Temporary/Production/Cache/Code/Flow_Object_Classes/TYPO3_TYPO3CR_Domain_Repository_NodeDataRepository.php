	 ...
	 protected function emitRepositoryObjectsPersisted() {
		...
		$result = parent::emitRepositoryObjectsPersisted();
			...
			try {
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Repository\NodeDataRepository', 'emitRepositoryObjectsPersisted', $joinPoint->getMethodArguments(), NULL, $result);
